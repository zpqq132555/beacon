# platform-distribution-scope Specification

## Purpose

Define the first-batch AI coding platform scope for the Beacon private distribution and keep CLI behavior, documentation, and tests aligned with that supported set.
