...
- [ ] 1.1 定义私有供应链配置结构，覆盖 Beacon 包来源、OpenSpec 包来源、Superpowers skill 来源和 CodeGraph 包来源。
- [ ] 1.2 实现项目配置与环境变量读取，并明确环境变量优先级。
- [ ] 1.3 为缺失私有来源提供统一的非致命状态和用户提示文本。
- [ ] 1.4 添加配置解析和优先级单元测试。
...
- [ ] 4.1 更新 CLI i18n 文案，避免把公开 npm/GitHub 作为唯一或默认私有来源。
- [ ] 4.2 更新 README 和 NEWS 中与供应链、公开安装命令、旧平台矩阵冲突的当前说明。
- [ ] 4.3 扩展 prepublish 检查或文档测试，阻止当前源码和文档重新引入公开源默认路径。
- [ ] 4.4 更新私有化功能模块台账中相关功能项状态。
