...
<p align="center">
  ...
  <a href="https://docs.github.com/packages/working-with-a-github-packages-registry/working-with-the-npm-registry"><img alt="GitHub Packages" src="https://img.shields.io/badge/registry-GitHub%20Packages-181717?style=flat-square&logo=github" /></a>
...
GitHub Packages 的推荐登录流程如下（只需做一次）：

```bash
npm login --scope=@zpqq132555 --auth-type=legacy --registry=https://npm.pkg.github.com
```

或者在用户目录或项目目录的 `.npmrc` 中配置：

```ini
@zpqq132555:registry=https://npm.pkg.github.com
...
```yaml
supply_chain.beacon.package: @zpqq132555/beacon
supply_chain.beacon.registry: https://npm.pkg.github.com
supply_chain.beacon.latest_metadata_url: https://your-metadata.example/beacon/latest
```
