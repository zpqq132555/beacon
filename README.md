<p align="center">
  <a href="https://github.com/zpqq132555/beacon/blob/master/img/title-log.png">
    <picture>
      <source srcset="https://github.com/zpqq132555/beacon/blob/master/img/title-log.png">
      <img src="https://github.com/zpqq132555/beacon/blob/master/img/title-log.png" alt="Beacon logo">
    </picture>
  </a>
</p>

<p align="center">
  <a href="https://github.com/zpqq132555/beacon/actions/workflows/ci.yml"><img alt="CI" src="https://img.shields.io/github/actions/workflow/status/zpqq132555/beacon/ci.yml?branch=master&style=flat-square&label=CI" /></a>
  <a href="https://deepwiki.com/zpqq132555/beacon"><img alt="DeepWiki" src="https://img.shields.io/badge/DeepWiki-zpqq132555%2Fbeacon-blue?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@oldpoint/beacon"><img alt="npm" src="https://img.shields.io/badge/registry-npmjs-CB3837?style=flat-square&logo=npm" /></a>
...
默认发布到 npmjs 公共 registry，所以公开安装链路不需要额外登录或 `--registry` 参数。建议优先将 Beacon 作为项目级依赖安装到你的仓库中：

```bash
npm install -D @oldpoint/beacon
```
...
```bash
npm uninstall -g @oldpoint/beacon
```

如果团队后续要换到其他私有源（例如 `@internal/beacon`），可在 `.beacon/config.yaml` 中同步设置 `supply_chain.beacon.package`。

最小项目接入只要求 Beacon 自身这三项来源配置：

```yaml
supply_chain.beacon.package: @oldpoint/beacon
supply_chain.beacon.registry: https://registry.npmjs.org
supply_chain.beacon.latest_metadata_url: https://registry.npmjs.org/@oldpoint%2Fbeacon/latest
```

默认只需要公开安装 Beacon 本身。OpenSpec、Superpowers、CodeGraph 仍可按团队现状保留为可选安装或管理员预装；如果后续要切回私有源，再覆盖上面的供应链配置即可。
...
<p align="center">
  <img src="https://github.com/zpqq132555/beacon/blob/master/img/runner.png" alt="runner">
</p>
...
`/beacon-init` 是项目 AGENTS 树维护入口，不属于五阶段主流程。手动调用时按当前工作区执行手动全量维护；归档阶段只有在内容值得沉淀时，才会先给出摘要建议，并在归档确认后增量沉淀到 AGENTS。
...
在 [Beacon Roadmap](https://github.com/zpqq132555/beacon/projects) 查看开发进展与即将推出的功能。

## Star历史

[![Star History Chart](https://api.star-history.com/svg?repos=zpqq132555/beacon&type=Date)](https://star-history.com/#zpqq132555/beacon&Date)

## Contributors

<a href="https://github.com/zpqq132555/beacon/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=zpqq132555/beacon&max=999&columns=12&anon=1" />
</a>
...
<table align="center">
  <tr>
    <td align="center" width="180">
      <img src="https://github.com/zpqq132555/beacon/blob/master/img/douyin.png" width="120" height="120"><br>
      <b>抖音群（推荐）</b>
    </td>
    <td align="center" width="180">
      <img src="https://github.com/zpqq132555/beacon/blob/master/img/wechat.jpg" width="120" height="120"><br>
      <b>微信群</b>
    </td>
    <td align="center" width="180">
      <img src="https://github.com/zpqq132555/beacon/blob/master/img/qq.jpg" width="120" height="120"><br>
      <b>QQ群</b>
    </td>
  </tr>
</table>
